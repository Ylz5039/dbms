...
import com.parser.ast.expression.arithmeic.*;
import com.parser.ast.expression.bit.*;
import com.parser.ast.expression.logical.*;
import com.parser.ast.expression.misc.*;
import com.parser.ast.expression.primary.*;
import com.parser.ast.expression.comparison.*;
import com.parser.ast.expression.primary.Identifier;
import com.parser.ast.expression.primary.MatchExpression;
import com.parser.ast.expression.primary.MatchExpression.Modifier;
import com.parser.ast.expression.primary.function.*;
import com.parser.ast.expression.primary.function.cast.*;
import com.parser.ast.expression.primary.function.comparison.*;
import com.parser.ast.expression.primary.function.datetime.*;
import com.parser.ast.expression.primary.function.groupby.*;
import com.parser.ast.expression.primary.function.spatial.*;
import com.parser.ast.expression.primary.function.string.*;
import com.parser.ast.expression.primary.function.string.Trim.*;
import com.parser.ast.expression.primary.literal.*;
import com.parser.ast.expression.string.*;
import com.parser.ast.expression.type.*;
import com.parser.recognizer.mysql.*;
...
public class MySQLExprParser extends MySQLParser {
    ...
    public MySQLFunctionManager getFunctionManager() {
        return functionManager;
    }

    public MySQLDMLSelectParser getSelectParser() {
        return selectParser;
    }
...
//        System.out.println("Parsed expression: " + left);
...
//            System.out.println("Current expression before OR: " + expr);
...
//                    System.out.println("Appending new expression: " + newExpr);
                ...
                switch (functionManager.getParsingStrategy(consumedUp)) {
                    ...
                    case GROUP_CONCAT:
                        ...
                        switch (lexer.token()) {
                            ...
                            case KW_SEPARATOR:
                                lexer.nextToken();
                                tempStr = LiteralString.getUnescapedString(lexer.getStringContent());
                                match(LITERAL_CHARS);
                                break;
                            default:
                                break;
