...
import com.parser.ast.expression.comparison.ComparisionEqualsExpression;
...
import com.parser.ast.stmt.compound.BeginEndStatement;
import com.parser.ast.stmt.compound.condition.*;
import com.parser.ast.stmt.compound.cursors.CursorCloseStatement;
import com.parser.ast.stmt.compound.cursors.CursorDeclareStatement;
import com.parser.ast.stmt.compound.cursors.CursorFetchStatement;
import com.parser.ast.stmt.compound.cursors.CursorOpenStatement;
import com.parser.ast.stmt.compound.flowcontrol.*;
...
import com.parser.ast.stmt.compound.condition.ConditionValue.*;
import com.parser.ast.stmt.compound.condition.GetDiagnosticsStatement.*;
import com.parser.ast.stmt.compound.condition.ResignalStatement.*;
import com.parser.ast.stmt.compound.condition.SignalStatement.*;
import com.parser.ast.stmt.compound.condition.DeclareHandlerStatement.*;
...
public class MySQLCmpdParser extends MySQLParser {
    ...
    public BeginEndStatement beginEnd(Identifier label) throws SQLSyntaxErrorException, IOException {
    ...
    public SQLStatement ifStmt() throws SQLSyntaxErrorException, IOException {
    ...
    public SQLStatement loop(Identifier label) throws SQLSyntaxErrorException, IOException {
    ...
    public SQLStatement repeat(Identifier label) throws SQLSyntaxErrorException, IOException {
    ...
    private SQLStatement whileStmt(Identifier label) throws SQLSyntaxErrorException, IOException {
    ...
    public SQLStatement caseStmt() throws SQLSyntaxErrorException, IOException {
    ...
    public SQLStatement parseWithIdentifier() throws SQLSyntaxErrorException, IOException {
        Identifier label = identifier();
        lexer.nextToken();
    ...
    public SQLStatement declare() throws SQLSyntaxErrorException, IOException {
